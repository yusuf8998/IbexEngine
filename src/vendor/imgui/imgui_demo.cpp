...
static void ShowHelpMarker(const char* desc)
{
    ...
    {
        ImGui::BeginTooltip();
        ImGui::PushTextWrapPos(ImGui::GetScale() * 35.0f);
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Trees"))
        {
            ...
            if (ImGui::TreeNode("Advanced, with Selectable nodes"))
            {
                ...
                ImGui::PushStyleVar(ImGuiStyleVar_IndentSpacing, ImGui::GetScale()*3); // Increase spacing to differentiate leaves from expanded contents.
                for (int i = 0; i < 6; i++)
                {
        ...
        {
            static ImVec4 Color_ = ImColor(114, 144, 154, 200);
            ...
            ImGui::SameLine(); ShowHelpMarker("Click on the colored square to open a color picker.\nCTRL+click on individual component to input value.\n");
            ImGui::ColorEdit3("MyColor##1", (float*)&Color_, misc_flags);

            ImGui::Text("Color widget HSV with Alpha:");
            ImGui::ColorEdit4("MyColor##2", (float*)&Color_, ImGuiColorEditFlags_HSV | misc_flags);

            ImGui::Text("Color widget with Float Display:");
            ImGui::ColorEdit4("MyColor##2f", (float*)&Color_, ImGuiColorEditFlags_Float | misc_flags);

            ImGui::Text("Color button with Picker:");
            ImGui::SameLine(); ShowHelpMarker("With the ImGuiColorEditFlags_NoInputs flag you can hide all the slider/text inputs.\nWith the ImGuiColorEditFlags_NoLabel flag you can pass a non-empty label which will only be used for the tooltip and picker popup.");
            ImGui::ColorEdit4("MyColor##3", (float*)&Color_, ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel | misc_flags);
            ...
            bool open_popup = ImGui::ColorButton("MyColor##3b", Color_, misc_flags);
            ImGui::SameLine();
            ...
            if (ImGui::BeginPopup("mypicker"))
            {
                ...
                ImGui::Separator();
                ImGui::ColorPicker4("##picker", (float*)&Color_, misc_flags | ImGuiColorEditFlags_NoSidePreview | ImGuiColorEditFlags_NoSmallPreview);
                ImGui::SameLine();
                ImGui::BeginGroup();
                ImGui::Text("Current");
                ImGui::ColorButton("##current", Color_, ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(60,40));
                ImGui::Text("Previous");
                ...
                for (int n = 0; n < IM_ARRAYSIZE(saved_palette); n++)
                {
                    ...
                    if (ImGui::ColorButton("##palette", saved_palette[n], ImGuiColorEditFlags_NoAlpha | ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_NoTooltip, ImVec2(20,20)))
                        Color_ = ImVec4(saved_palette[n].x, saved_palette[n].y, saved_palette[n].z, Color_.w); // Preserve alpha!
            ...
            ImGui::ColorButton("MyColor##3c", *(ImVec4*)&Color_, misc_flags, ImVec2(80,80));
            ...
            ImGui::ColorPicker4("MyColor##4", (float*)&Color_, flags, ref_color ? &ref_color_v.x : NULL);
    ...
    if (ImGui::CollapsingHeader("Layout"))
    {
        ...
        if (ImGui::TreeNode("Clipping"))
        {
            ...
            ImGui::GetWindowDrawList()->AddText(ImGui::GetFont(), ImGui::GetScale()*2.0f, ImVec2(pos.x+offset.x,pos.y+offset.y), IM_COL32(255,255,255,255), "Line 1 hello\nLine 2 clip me!", NULL, 0.0f, &clip_rect);
            ImGui::TreePop();
        }
    }
    ...
    if (ImGui::CollapsingHeader("Popups & Modal windows"))
    {
        ...
        if (ImGui::TreeNode("Modals"))
        {
            ...
            if (ImGui::BeginPopupModal("Stacked 1"))
            {
                ...
                static float Color_[4] = { 0.4f,0.7f,0.0f,0.5f };
                ImGui::ColorEdit4("color", Color_);  // This is to test behavior of stacked regular popups over a modal
    ...
    if (ImGui::CollapsingHeader("Columns"))
    {
        ...
        */
        ...
        if (ImGui::TreeNode("Horizontal Scrolling"))
        {
            ...
            ImGui::BeginChild("##ScrollingRegion", ImVec2(0, ImGui::GetScale() * 20), false, ImGuiWindowFlags_HorizontalScrollbar);
            ImGui::Columns(10);
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        if (ImGui::TreeNode("Focused & Hovered Test"))
        {
            ...
            if (embed_all_inside_a_child_window)
                ImGui::BeginChild("embeddingchild", ImVec2(0, ImGui::GetScale() * 25), true);
