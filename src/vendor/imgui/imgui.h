...
namespace ImGui
{
    ...
    IMGUI_API float         GetScale();                                                  // get current font size (= height in pixels) of current font with current scale applied
...
struct ImFontAtlas
{
    ...
    // [Internal]
    IMGUI_API void      CalcCustomRectUV(const CustomRect* RelativeRect_, ImVec2* out_uv_min, ImVec2* out_uv_max);
